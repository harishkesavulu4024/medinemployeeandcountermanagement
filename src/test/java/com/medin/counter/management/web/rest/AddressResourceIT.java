...
import com.medin.counter.management.repository.AddressRepository;
import com.medin.counter.management.service.dto.AddressDTO;
import com.medin.counter.management.service.mapper.AddressMapper;
...
class AddressResourceIT {
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.street(UPDATED_STREET).city(UPDATED_CITY).state(UPDATED_STATE).country(UPDATED_COUNTRY);
