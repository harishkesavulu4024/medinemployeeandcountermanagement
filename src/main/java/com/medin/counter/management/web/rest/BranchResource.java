...
/**
 * REST controller for managing {@link com.medin.counter.management.domain.Branch}.
 */
@RestController
@RequestMapping("/api")
public class BranchResource {
     ...
     */
    @GetMapping("/branches")
    public ResponseEntity<List<BranchDTO>> getAllBranches(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
